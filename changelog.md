...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.47.0/BetterGI.Install.0.47.0.exe)
...
- 删除 “允许在jsScript脚��中使用此地图追踪配置” 和 “允许在此调度器中（一般在JS脚本中）调用自动战斗任务时，采用此追踪配置里的战斗策略” 配置。默认启用
- 脚本仓库更新添加进度展示
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.46.2/BetterGI.Install.0.46.2.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.46.0/BetterGI.Install.0.46.0.exe)
...
* 自动拾取黑名单添加条目 #1545
* 安装器优化与集成 @xytoki
* 添加 Mirror 酱 更新渠道，主程序更新推���支持灰度更新
* 修复更新窗口色差以及白边的问题
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.45.1/BetterGI.Install.0.45.1.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.44.4/BetterGI.Install.0.44.4.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.44.3/BetterGI.Install.0.44.3.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.44/BetterGI.Install.0.44.0.exe)
...
- 新增关于页
- 迁移按键绑定页面到设置中
- 自动钓鱼���复 16:9 的支持，**与一些钓鱼功能的优化** @FishmanTheMurloc 
- 一些UI界面上的变化
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.43.1/BetterGI.Install.0.43.1.exe)

### 更新内容

```
* **修复全自动钓鱼导致机器内存占满��问题** @FishmanTheMurloc 
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.43/BetterGI.Install.0.43.0.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.42/BetterGI.Install.0.42.0.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.41/BetterGI.Install.0.41.0.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.40/BetterGI.Install.0.40.0.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.39/BetterGI_Setup_v0.39.1.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.38/BetterGI_Setup_v0.38.1.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.37/BetterGI_Setup_v0.37.1.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.36/BetterGI_Setup_v0.36.1.exe)
...
* 新增 action，具体��[文档](https://bgi.huiyadan.com/feats/autos/pathing.html)
  * 水、雷、风元素力采集
  * 周边拾取 #721 @jbcaaa 
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.35/BetterGI_Setup_v0.35.0.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.34/BetterGI_Setup_v0.34.1.exe)
...
由 @HZYgrandma 贡献，由于使用的是和自动晶蝶一样的自动传送+键鼠录制的方式，长距离可能无法精准到达点位。且由于键鼠录制不够稳定，出现无法正确拾取狗粮的情��属于正常情况。后续可能会通过地图追踪功能重写。
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.33/BetterGI_Setup_v0.33.2.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.32/BetterGI_Setup_v0.32.1.exe)
...
* 自动伐木默认不再开���OCR识别木材数量的功能（部分木材100%识别失败） #444
* 自动剧情添加了随机点击选项的选择
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.31.0/BetterGI_Setup_v0.31.1.exe)
...
* 修复��瑟琳每日自动领取委托/自动重新派遣关闭功能无效的问题 https://github.com/babalae/better-genshin-impact/issues/417
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.30.0/BetterGI_Setup_v0.30.2.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.29.0/BetterGI_Setup_v0.29.4.exe)
...
**此改动过大，未完整进行测试，如果出现部分功能不可用的情况，请�� Issue 告诉我。**
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.28.0/BetterGI_Setup_v0.28.0.exe)
...
* 自动邀约添加分支选择功能，感谢@wy3057与群友`癫誑`整理的全邀约分支数据！
    * 人工整理数据难免有错漏，分支有问题请发[issue](https://github.com/babalae/better-genshin-impact/issues)并提供相关文案与截图，帮助我们��正错误
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.27.0/BetterGI_Setup_v0.27.1.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.26.0/BetterGI_Setup_v0.26.2.exe)
...
## 独立任务
- 自动战斗、自动七圣召��脚本下拉框动态刷新 #268 @Mr-Quin
- 自动秘境指定轮数完成后，退出副本
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.25.0/BetterGI_Setup_v0.25.0.exe)
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.24.0/BetterGI_Setup_v0.24.1.exe)
...
## 快捷键
- 快捷键新增键鼠监听模式，**支持��意键盘单键、鼠标侧键（XButton1、XButton2）**，不支持组合键，在更好的原神启动后才生效。#6  #45 #123 #228
...
- **新增了自动提交物品的功能**。由于没有找到多个��品的测试场景，所以现在只支持一个物品。
...
## 快速传送
- 更加精准的快速传送，**在存在多个传送点的情况下会选择第一个传送点**，当然消耗的性能也���加了
- 新增按住快捷触发快速传送的方式 #127
- 新增了快速传送的开关快捷键 #229 
...
- WindowsGraphicsCapture截图方式的优化，确保能够获取到最新图片，减少截图失败��报错
...
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.23.0/BetterGI_Setup_v0.23.0.exe)
...
**版本:** `0.22.0`
**发布时间:** 2024/1/14 22:38:44
**GitHub页面:** [查看详情](https://github.com/babalae/better-genshin-impact/releases/tag/0.22.0)
**下载链接:** [点击下载](https://github.com/babalae/better-genshin-impact/releases/download/0.22.0/BetterGI_Setup_v0.22.0.exe)
...
## 自动战斗与秘境
战斗
- **战斗脚本���加宏类方法，比如：click, keydown, keyup 等，具体使用方法见[高级语法](https://bgi.huiyadan.com/feats/domain.html#%E6%88%98%E6%96%97%E7%AD%96%E7%95%A5%E8%84%9A%E6%9C%AC-%E9%AB%98%E7%BA%A7%E8%AF%AD%E6%B3%95)**
...
![image](https://github.com/babalae/better-genshin-impact/assets/15783049/b3ed51fb-d97e-4a85-8d58-81a068b64ff6)

- 修复循环次数不起效的问题
- 修复识别单个文字不准确的问题，也就是浓缩���脂无法正确识别的问题。（再也不会刷一半退出了）
