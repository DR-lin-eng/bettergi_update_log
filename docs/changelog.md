...
## 其他优化
- 优化抽屉关闭后重新开启的体验
- 一条龙页面��加自动秘境树脂选择弹窗 #1767 @kaedelcb
...
* 修复AutoPathing下的非顶层文件夹不��示图标的问题  #1665 @Patrick-Ze
* 延长塞西莉亚苗圃的行走时间 #1620
...
点击启动一条龙的是后，如果截图器未自动启动会直接启动，且会等待到开门后开始执行��条龙。
...
> **[minimap](https://github.com/tignioj/minimap) 是一个高精度原神自动采集工具，��然它的功能远不止这些，强烈推荐！！**
