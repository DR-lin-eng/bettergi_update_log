...
### JS脚本
- 新增材料合成与背��物品计数接口，支持材料筛选、数量设置、产物识别及多物品计数 (#3231) @1004452714
...
- 新增自动剧情点击对话框前的延迟设置
- 减少配置组中两个任务中间的���待时间 @JamisHoo (#2590)
...
- 取消兑换码使用后不再弹出此剪���板内容的兑换码，新增兑换码剪切板监听的开关配置
