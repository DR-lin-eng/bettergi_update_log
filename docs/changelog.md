...
### JS脚本
- 新增材料合成与背包���品计数接口，支持材料筛选、数量设置、产物识别及多物品计数 (#3231) @1004452714
...
## 自动秘境/幽境/战斗
- 战斗策略中，上一个命���和当前命令不是同一个角色时，直接切换角色 #2411
...
* 修复路径追踪 `combat_script` 不设置角色名称仍会切��的问题 #1100
