...
## 其他
- 新��状态机模块，重构幽境危战任务 (#2712) @ShadowLemoon
...
## 自动战斗/秘境/幽境危战
- 新增 `round` 指令：��持按轮次激活部分战斗宏脚本 @NyaMisty (#2597)
...
> [!IMPORTANT]
> **非常感谢 @Limint 贡献的新的相机视角识别算法，解决了路径追踪时���角晃动的问题**
