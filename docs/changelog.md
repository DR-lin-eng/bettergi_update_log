...
- 优化地图切换���域时的文本检测区域 (#2275) @ShadowLemoon
...
## 其他优化
- 优化新版本更新日志窗口的背景显示(未��全解决) (#1413) @richex-cn
...
* 修复地图追踪时其他界面关闭后没有延时，以及大地图界面���应该被关闭的问题
* 修复树脂不足提示检测 #1385
...
- 一些UI界面上的变化
- wpfui 更新至 4.0 (表层��啥变化，但是ui框架底层变动)
...
* 在未识别到配队选择页面时重试
* 新增命令行： `.\BetterGI.exe startOneDragon`，支持在��件启动后直接启动一条龙 #998
...
### 路径追踪
* 修复到目标点时不转动视角的问题
* 在识别到卡死时，新增更好的避障逻��� & 优化寻路逻辑 #711 @jbcaaa 
...
> [!IMPORTANT]
> **地图追踪功能**：自动传送到最近的锚点，然后根据小地图开始寻路。系统会根据任务文件的途径点和��标点进行导航。
