...
* 优化路径追踪地图点位编辑器的功能（战斗策略管理、清空���） @mfkvfhpdx 
...
> **当前已实��自动采集功能，核心功能由 @lwh9346 参考 https://github.com/tignioj/minimap 开发完成**
...
## 自动剧情与邀约
* 新增一种**后台点击模式**，开启��自动剧情和邀约可以在后台被点击。
