...
- 修复七圣召唤月之五伊涅芙会导致���牌不可调和的死循环 (#2848) @Guest-Liang
...
## 其他
- **同时启动原神的功能，添加使用CMD启动游戏的入口，如果你出现“检测���非法工具，请重启机器”的提示，可以尝试此功能**
...
- 修复ItemsSource=' 1234' 导致XAML设���器报错的问题 #2039
...
## 自动拾取
- **拾取列表已满时候，滑动滚轮（注意这个变更会会导致拾取变成从下往上拾取，对于尘歌��收菜有一定影响）**
...
- 优化一些报错和日志提示
- 支持5.6新角色的识别
- 修��一个UI上数据绑定的问题 @FishmanTheMurloc
