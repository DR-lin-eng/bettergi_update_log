...
- 优化奖励页就绪检测与��量识别，减少奖励汇总遗漏 (#3476 #3494) @1004452714
...
- 新增角色战技赶路，支��多名角色与连续赶路模式，并完善体力判断和下车逻辑 (#3280 #3319 #3328 #3336 #3367) @Bedrockx
...
- 一条龙支持重复添加任务和从指定书签继续执行，并保��各任务实例的独立配置 (#3276) @Bedrockx
