...
- 修复自动秘境选择火本（无妄引咎密宫）后，��法正确进入秘境的问题 #1345
...
* 自动秘境功能存在角色死亡���，如果设置了目标秘境，则会自动传送回去继续自动秘境
