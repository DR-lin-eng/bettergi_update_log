...
- 修复自定义的交互按键未对自动秘���生效的问题 (#2035) @Patrick-Ze
- 地图追踪中新增使用小道具的action
...
- **新增支持独立地图层岩巨渊、渊下宫，录制编辑器和追踪地图查看同���支持**
...
- 新增关于页
- 迁移按键绑定页面到设置中
- 自动钓鱼恢复 16:9 的支持，**与一些钓鱼功能的��化** @FishmanTheMurloc 
- 一些UI界面上的变化
...
* 添加使用Starward记录游戏时间的功��� @kndxhz #1164
...
**此改动���大，未完整进行测试，如果出现部分功能不可用的情况，请提 Issue 告诉我。**
...
## 其他优化
* Yap 自动拾取模型更新
* 修复原神启动时，`config.ini` 不生效的问题（用了官B切���工具，但使用BetterGI启动时永远是官服）
