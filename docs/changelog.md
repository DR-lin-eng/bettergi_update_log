...
- 一些UI界面上的变化
- wpfui 更新至 4.0 (表��没啥变化，但是ui框架底层变动)
...
* 修复脚本订阅和配置组运行的提��框在高DPI显示屏下跑到屏幕外的问题
...
**新增了一条龙功能，一键完成��常，更多一条龙功能计划请查看 https://github.com/babalae/better-genshin-impact/issues/846**
...
* 一键进出尘歌壶，增加对多人联机下进入尘歌壶的��持 @FannieMC
...
**自动调查离传送点较近的狗粮。请使用琳妮特前台，双风共鸣。并保证所有��送点都已经激活！**
