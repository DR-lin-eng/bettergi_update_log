...
## 其他优化
- 优���新版本更新日志窗口的背景显示(未完全解决) (#1413) @richex-cn
...
## 自动秘境
- 一条龙未选择要刷的秘境时，直接提示
- 修复4K分辨率下秘境无���自动点击掉地脉异常的提示内容的问题 #460
...
* **修复通知导致的截图失败报错提示**
* �� JS脚本 中的 keyDown(), keyUp(), keyPress() 方法 和 战斗策略脚本 中的 keydown(), keyup(), keypress() 方法 可以直接使用 虚拟键代码 来执行 鼠标操作 #1124 @2696791698
...
通知���档：https://bettergi.com/dev/webhook.html
...
* ���复脚本订阅和配置组运行的提示框在高DPI显示屏下跑到屏幕外的问题
