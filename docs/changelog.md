...
## 其他
- **修复JSON序列化问题，本质原因是OCR模块指针指向的内存出现错误，��谢群友 焦糖玛奇朵
 提供环境协助定位！**。
...
- tp.json 元数据更新，更新秘境选择的材料���示 @JamisHoo
...
- 修��� AutoDomainParam 泛型定义 @breadgrocery
...
- 提高领取��行奖励的鲁棒性（实际是V5 OCR识别的问题） #2019 @JamisHoo
...
- 小改正则表达以支��JS脚本统计 @MisakaAldrich #1274
- 优化一条路合成树脂时候容易失败的问题
...
* 自动秘境中的战斗策略存在火神的情况��，战斗结束后自动切人 #1052
```
...
### 调度器
* 添加配置组设置功能，可以���置路径追踪队伍切换、使用盾、回血角色等
* 添加连续执行的功能
...
> **当前已实现自动采集功能，核心功能由 @lwh9346 ���考 https://github.com/tignioj/minimap 开发完成**
