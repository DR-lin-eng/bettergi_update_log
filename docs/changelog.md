...
- 地图追踪增加读取目录下的内容等方��� (#2875) @1004452714
...
## 其他
- ��增状态机模块，重构幽境危战任务 (#2712) @ShadowLemoon
...
- 优化自动战斗出战角色识别，修复部分��景下无法正常识别出战角色的问题
- 延长秘境载入判断时间 #2470
...
- 适配更多 6.0 队伍相关���造 @kaedelcb @FishmanTheMurloc
...
* 优化一条龙领取奖励时，橙色选项的识别率
* 修改所有自���战斗的键鼠模拟方式，尝试修复自动战斗原地不动的问题
* 部分UI改造，部分文案修正
```
...
**在自动音游的��础上，新增自动专辑功能。在专辑界面下运行可以自动演奏完所有未领取完奖励的乐曲。**
...
* **后台自动剧情模式不再会瞬移鼠标点击，直接使用5.2的F**，注��对话结束后鼠标仍会被吸附到游戏窗口内！
