...
* 地图追踪中异常场景处理添加 遇到 x 按钮时候 ��下ESC返回主界面
...
* 自动秘境中的战斗策略存在火神的情况下，��斗结束后自动切人 #1052
```
...
**在自动音游的基础上，新增自动专辑功能。在专辑界面下运行可以自动演奏完所有未领取完奖���的乐曲。**
