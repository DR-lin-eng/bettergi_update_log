...
```
- **修复一键宏卡死问题** @cookie981
- 优化一条龙每周秘境��置与下拉选择显示 (#3142) @ShadowLemoon
...
## OCR 相关
- **OCR���型更新至 PaddleOcrV5** (#1966) @Takaranoao
- 强制OCR使用CPU的功能默认关闭
...
- 调度器配置中增加执行成功任务跳���执行配置 (#1893) @mfkvfhpdx
...
* 自���战斗后、传送前都会释放所有按键，尝试解决TP神像后持续往前走的问题
* 修复火元素采集不生效的问题
* 优化自动传送的稳定性 @physligl
