...
- tp.json 元数���更新，更新秘境选择的材料展示 @JamisHoo
...
- 挪德卡莱中心点更新（修复不会自动选择挪德卡莱的问题）/联机时不���行自动派遣 (#2323) @kaedelcb
...
- **自动幽境危战适配5.8，并加入一条龙中（注��当前无需在开启钥匙后的界面上启动本功能！）**
...
- ���复创建配置组添加js脚本后，首次编辑js脚本自定义配置时，组件无法正确绑定到setting.json中的默认值 (#1449) @breadgrocery
- 调用切换队伍方法后，清除队伍缓存
