...
- 修复地图追踪配置中获��材料名称的问题 (#1919) @kaedelcb
- 地图追踪版本要求修改为强制
- 优化地图追踪的距离过远判断
...
* 支持在命令行启动一条龙参数时选择配置，配置找��到就用界面指定的 #1586 @zzc-tongji
...
* 修复 BitBlt 会崩溃的问题，以及 BitBlt 性能的极��优化 @Takaranoao
* WGC帧率控制
...
* ���增路径点位 `orientation` 用于控制人物朝向 @Yang-z 
* 路径追踪中自动跳过剧情的配置为强制跳过
