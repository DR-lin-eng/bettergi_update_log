...
```
> [!CAUTION]
> 0.63 版本识图素材底层重构，可能存在较多��知 BUG ，当前版本并不稳定，请谨慎选择更新！
...
- 自动秘境和自动首领讨伐新增奖励名称与��量识别、跨轮汇总及 JS 返回结果支持 (#3208) @1004452714
...
- 优化自���战斗出战角色识别，修复部分场景下无法正常识别出战角色的问题
- 延长秘境载入判断时间 #2470
...
- 修复打开活动一览操作可能提前的问题
- 修复幽境危战活动不���首位无法正常传送的问题 #2059 #2060
...
- 修复迷烟主成员非飞行状态下四叶印识别失败的Bug，模板匹���的置信度修改为数组 @Limint
