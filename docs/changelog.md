...
* 联机情况下识别角色队伍时，修复错误识别房主的问题（会导致队伍识别出���） #777
...
* 更新角色识别模型，支持艾梅莉埃、��齐娜、玛拉妮、基尼奇的识别与战斗策略编写
...
```
## 新功能
**新增了自动烹饪的功能，在实时任务中开启（不用��时候请关闭，比较消耗性能）** #266
