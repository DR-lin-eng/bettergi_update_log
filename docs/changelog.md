...
```
> [!CAUTION]
> 0.63 版本识图素��底层重构，可能存在较多未知 BUG ，当前版本并不稳定，请谨慎选择更新！
...
- 优化任务状态机的转场等待与当��节点重试判定，避免中间态超时被误计为当前节点重试 (#3182) @ShadowLemoon
...
- 地图追踪版本要求修改为强制
- 优化地图追踪的距离过远判断
- 修复地图追踪中角色公转的场景，持续角度一直未在5度内时，���接强制等到转向到目标位置 #1644
