...
- 新增遮罩样��自定义并支持分辨率与 DPI 自适应，可分别调整日志和指标栏缩放 (#3184 #3352) @ddaodan @kaedelcb
...
- 自动秘境和自动首领讨伐新增奖励名称与数���识别、跨轮汇总及 JS 返回结果支持 (#3208) @1004452714
...
- 修复打开活动一览操作可能提前的问题
- 修复幽境危战活动不在首位无法正常传送���问题 #2059 #2060
...
- 修复迷烟主成员非飞行状态下四叶印识别失败的Bug，模板匹配的置信度修改为数��� @Limint
