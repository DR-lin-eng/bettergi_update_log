...
```
> [!CAUTION]
> 0.63 版本识图素材底���重构，可能存在较多未知 BUG ，当前版本并不稳定，请谨慎选择更新！
...
- 优化任务状态机的转场等待与当前节��重试判定，避免中间态超时被误计为当前节点重试 (#3182) @ShadowLemoon
...
## 其他
- **Yap 的推理对象改为懒加载。index_2_word.json 修改成 Newtonsoft.Json 反序列化。修复 #2890 （也就是修复���这个报错：System.NotSupportedException: The type 'System.Int32' is not a supported dictionary key...）**
...
- 优化��日委托领奖，使用点击屏幕替代按ESC (#2761) @zaodonganqi
...
🌩️ [Github 下载太��？ 点我访问更多更新渠道](https://bettergi.com/download.html)
...
## 一条龙
- 领取尘歌壶奖励优化，新增其他进入尘��壶的方式 (#1797) @iris10086
...
**[点我查看 0.46.0 ���更新日志](https://github.com/babalae/better-genshin-impact/releases/tag/0.46.0)**
...
- 自动剧情关闭弹���页前判断是否是大地图的弹出页面，以防误识别 #1466
...
* ��复路径追踪 `combat_script` 不设置角色名称仍会切人的问题 #1100
