...
## 其他
- 优化自动拾取的预处理环节，优化最终文���展现，使自动拾取OCR识别更加稳定
- **自动拾取排除聚所**
- 自动秘境浓缩树脂识别优化
- 自动音乐专辑任务异常详情日志打印
...
```
> [!CAUTION]
> 由于本次更新修改了底层截图器与任务调度，这并不是一��稳定的版本，请谨慎选择更新！
...
> [!IMPORTANT]
> **非常感谢 @Limint 贡献的新的相机视角识别算法，解决了路径追踪时视��晃动的问题**
