...
- 修复七圣召唤月之五伊���芙会导致手牌不可调和的死循环 (#2848) @Guest-Liang
...
## 其他
- **同时启动原神的功能，添加使用CMD启动游戏的入口，如果你���现“检测到非法工具，请重启机器”的提示，可以尝试此功能**
...
- 给没有跟随主题的弹窗UI加上跟随��题的功能 (#2461) @ShadowLemoon
...
- 修复ItemsSource=' 1234' 导致XAML设计器报错���问题 #2039
...
- 修复地图追踪配置中获取���料名称的问题 (#1919) @kaedelcb
- 地图追踪版本要求修改为强制
- 优化地图追踪的距离过远判断
...
* 修复���定义拾取按键不生效的问题 #1262 @Takaranoao
