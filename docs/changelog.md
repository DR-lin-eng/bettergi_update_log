...
* 修复了角色在自动秘境结束战斗时，若朝向正西���则无法自动转向古树的问题。 #608
...
* 更新角色识别模型，支持艾梅莉埃、卡齐娜、玛拉妮、基尼奇的识别与战��策略编写
...
**感觉自动拾取有掉帧的朋友可以切换到GPU进行推理，然后自动拾取文字识别引擎选择 Yap，这样 CPU 占用会���幅降低。**
