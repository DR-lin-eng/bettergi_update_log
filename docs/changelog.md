...
- 修复使���ESM时，仅使用同步代码报错 (#2592) @breadgrocery
...
- 修复迷烟主成员��飞行状态下四叶印识别失败的Bug，模板匹配的置信度修改为数组 @Limint
...
- 优化自动重新��录针对B服的登录框的操作，支持5.8版本的新登录框 @zaodonganqi
