...
## 一条龙
* 自动秘境：添加周日材料本三种奖励选择、优化���入秘境横幅点击 @kaedelcb
...
* 添加可以按照正则分解���星圣遗物的 (#1383) @FishmanTheMurloc
* JS 脚本新增文件写入、输入文字的能力
...
**识别��路来自群友 `@益蜘蛛` ，实现方法参考了另一位群友@DR-lin-eng编写的自动音游程序： https://github.com/DR-lin-eng/genshin-auto-music**
