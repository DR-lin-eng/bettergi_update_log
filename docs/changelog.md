...
### 独立任务
- 修复自动地脉花追踪按��识别与奖励页树脂点击异常 (#2971) @ddaodan
...
- **修复���小化时候截图失败导致截图器没法正常截图，导致主界面卡顿的问题** #2939  #2851 
...
- 修复同时存在多个���本仓库文件夹时迁移优先级出错 (#2906) @Shadow-Lemon
...
## JS相关
- 支持调用 C#中含out/ref参数的��法 (#2884) @1004452714
