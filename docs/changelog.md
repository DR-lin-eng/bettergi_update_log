...
**新增了一条龙功能，一键完成日常，更多一条龙功能计划��查看 https://github.com/babalae/better-genshin-impact/issues/846**
...
### 路径追踪
* 修复到目标点时不转动视角的问题
* 在识别到卡死���，新增更好的避障逻辑 & 优化寻路逻辑 #711 @jbcaaa 
...
* 修复凯瑟琳每日自动领取委托/自动重新派遣关闭功能���效的问题 https://github.com/babalae/better-genshin-impact/issues/417
