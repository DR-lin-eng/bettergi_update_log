...
- 调整官��退出重进参数，对高ping玩家友好一点 (#1986) @Takaranoao
...
![image](https://github.com/user-attachments/assets/47b54ac1-b524-4f62-a7a0-8e2b83221cf0)
    ...
    * 解决方案：关掉后重试一次，手动运行BetterGl.update.exe（此时打开软件应��已经是最新版了）。如果还是不行，可以直接重新下载安装包安装。
...
* 尘歌壶：优化阿园寻找��成功率，购买商品添加设置 @kaedelcb
* 部分功能优化 @kaedelcb
...
由于通知功能未完��，**每日奖励可能存在未领取的情况**，暂不提供完成一条龙后关机的功能。
...
* 更新角色识别模型，支持艾梅莉埃、卡齐娜、玛拉妮、基尼奇的识别��战斗策略编写
