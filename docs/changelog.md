...
- **修复自动秘境使用指定树脂数量超出实际树脂数���时，不会自动退出秘境的问题**
- 修复重复退出秘境的问题
...
- 圣遗物分解套装筛选���改进和JS引擎的约束 (#2319) @FishmanTheMurloc
...
```
> [!CAUTION]
> 由于本次更新修改了底层截图器与任务调���，这并不是一个稳定的版本，请谨慎选择更新！
...
* 地图追踪中异常场景处理添��� 遇到 x 按钮时候 按下ESC返回主界面
