...
- 取消兑换码使用后不再弹出此剪切��内容的兑换码，新增兑换码剪切板监听的开关配置
...
## 调度器
* 调度器清空所有任务添加询问提示
* 新增shell类型的任务可供添��（**请不要执行看不懂的命令**）#1248 @Takaranoao
...
* 修���了路径追踪中战斗结束的判定点 @Scarlet1ssimo
