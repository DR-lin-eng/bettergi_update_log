...
## 新功能
- **新增后台角色技能CD显示功���**，在遮罩窗口显示后台角色的技能冷却时间 (#2754) @zaodonganqi
...
## 其他
- 优化自动剧情-关闭弹窗-小道具的检测逻�� (#2427) @1004452714
...
- 调整浓缩树脂识别范围，解决V4模型无法准确识��浓缩树脂个数的问题 #2185
...
- 取消兑换码使用��不再弹出此剪切板内容的兑换码，新增兑换码剪切板监听的开关配置
...
🌩�� [Github 下载太慢？ 点我访问更多更新渠道](https://bettergi.com/download.html)
...
- **地图特征使用二进制文��存储，减小文件体积，大幅提升特征数据加载速度** @shatyuka
...
- 自动剧情关闭弹出页前判断是否是大地图的��出页面，以防误识别 #1466
...
* 修复路径追踪 `combat_script` 不设置角色名称仍会切人��问题 #1100
...
* 感谢 @Womsxd 提供的额外流量节点！
* 感谢 @qhy040404 编���的 Github Action！
