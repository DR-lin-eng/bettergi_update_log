...
## 一条龙
* 自动秘境：添加周日材料本三种奖励选择、优���进入秘境横幅点击 @kaedelcb
...
* 添加可以按照正则分���五星圣遗物的 (#1383) @FishmanTheMurloc
* JS 脚本新增文件写入、输入文字的能力
...
- 增加对WaypointForTrack的DisablePickupAround属��支持，可以关闭挖矿动作的周围拾取 @Takaranoao #1322
...
## 其他优化
* **修复非16:9屏幕在 0.29 版本新出现的问��：无法正常使用部分功能、遮罩识别框位置不正确**
...
为了���决自动拾取的高占用，新增了一个OCR识别引擎，识别速度稍慢但是占有低，并作为默认选项。解决此类卡顿问题：#383
