...
- 由于 TextBox 的 PlaceholderText 不展示，新增���多文字指引
...
- 删除这两个选项：是否就近七天神像恢复血量、传送到���天神像之后是否需要移动后回血
...
## 调度器
* 调度器清空所有任务添加询问提示
* 新增shell类型的任务可供添加（**请���要执行看不懂的命令**）#1248 @Takaranoao
