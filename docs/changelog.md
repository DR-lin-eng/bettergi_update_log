...
- 优化自动剧���-可提交物品的识别方法 (#2477) @1004452714
...
## 其他
- 修复 OpenVINO 缓��配置与描述冲突（注：当前正式版 OpenVINO 不能启用） @Luckylhz
...
## 其他优化
- 优化抽屉关闭后重新开启的体验
- 一条龙页面添加��动秘境树脂选择弹窗 #1767 @kaedelcb
...
* 修复AutoPathing下的非顶层文件夹不显示��标的问题  #1665 @Patrick-Ze
* 延长塞西莉亚苗圃的行走时间 #1620
...
- 启动时检查是否有关键文件缺��，缺失时提示 #468 @qhy040404 
