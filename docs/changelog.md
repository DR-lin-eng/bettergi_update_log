...
* 修复更新窗口色差以及白边的问题
* 修复暂停后���复异常bug，调度器设置增加周期配置，执行调度器任务增加继续执行功能 @mfkvfhpdx
...
```
BetterGI 距离第一个版本 0.10.0 的发布刚好���经过去了一年时间了，没想到能高强度开发一年，把 Github 的瓷砖都快刷全绿了。感谢各位开发者和群友们的帮助！
...
## 独立任务
- 自动战斗、自动七圣召唤���本下拉框动态刷新 #268 @Mr-Quin
- 自动秘境指定轮数完成后，退出副本
...
## 自动战斗与秘境
战斗
- **战斗脚本���加宏类方法，比如：click, keydown, keyup 等，具体使用方法见[高��语法](https://bgi.huiyadan.com/feats/domain.html#%E6%88%98%E6%96%97%E7%AD%96%E7%95%A5%E8%84%9A%E6%9C%AC-%E9%AB%98%E7%BA%A7%E8%AF%AD%E6%B3%95)**
...
- 添加���境结束的标志判断（现在会判断上方“挑战达成”文字，更快结束战斗环节）
