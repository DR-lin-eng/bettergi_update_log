...
## 其他
- 优化自动剧情-关闭弹窗-小��具的检测逻辑 (#2427) @1004452714
...
## 地图追踪 & 自动战斗
- **新的队伍��号识别方式，解决菈乌玛UI造成角色切换相关的问题，修复一键宏无法正常使用的问题**
- **6.0分层传送锚点、地下地图**
...
- **新增独立任务自动使用��换码，自动识别剪切板中的兑换码** (#1895)
...
- **地图特征使��二进制文件存储，减小文件体积，大幅提升特征数据加载速度** @shatyuka
...
- 自动剧情关闭弹出页前判断是否��大地图的弹出页面，以防误识别 #1466
