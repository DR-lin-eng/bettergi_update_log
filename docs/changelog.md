...
- 自动秘境浓缩树脂识别优化
- 自动音乐专辑任务异常详情日志打印
- ��加“打开所在目录”菜单项及其命令实现，用于打开脚本文件夹 (#2193) @bling-yshs
- 更新软件图标尺寸 @bling-yshs
...
- 由于 TextBox 的 PlaceholderText 不展示，��增更多文字指引
...
- 删除这两个选项：是否就近七天神像恢复血量、传��到七天神像之后是否需要移动后回血
...
* 修复AutoPathing下的非顶层文件夹不显��图标的问题  #1665 @Patrick-Ze
* 延长塞西莉亚苗圃的行走时间 #1620
...
**在自动音游的基础上，新增自动专辑功能。在专辑界面下���行可以自动演奏完所有未领取完奖励的乐曲。**
...
* 更新角色识别模型，支持艾梅莉埃、卡齐娜、玛拉���、基尼奇的识别与战斗策略编写
