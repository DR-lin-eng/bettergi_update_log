...
- 修复切换队伍���取初始队伍为空的异常识别 (#2688) @kaedelcb
...
- 优化自动���情-可提交物品的识别方法 (#2477) @1004452714
...
- 为凌晨4���领取月卡的逻辑添加了更多触发点 @mfkvfhpdx
...
- 发送通知时，添加延迟让图片先发送，时��戳与事件之间添加换行 @MisakaAldrich
...
## 调度器
* 调度器清空所有任务添加询问提示
* 新增shell类型的任���可供添加（**请不要执行看不懂的命令**）#1248 @Takaranoao
