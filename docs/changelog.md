...
- **优化自动拾取对聚所的判断**
- **自动拾取添加模糊匹配的名单**
- 自动��遗物转化功能可识别并标记未激活副词条 (#2258) @bhbghghbgb
...
- 添加火元素采集选项到条件定义 #2159
- 优化 地图追踪任务添加窗口 性能，修复了索引时文件树复选框不被记忆���BUG (#2157) @Datouyu666
...
* 修��其他树脂存在，但是原粹树脂耗尽的情况下，会自动退出秘境的问题
...
- 打开��图时判断是否存在探索奖励，并自动领取（需要在设置中打开） @mfkvfhpdx 
...
- 修复提示框内��过长时，对话框无法完整显示的问题 (#1513) @breadgrocery
- 优化一些报错和日志提示
- 支持5.6新角色的识别
...
> [!IMPORTANT]
> **非常感谢 @Limint 贡献的新的相机视角识别算法，解决了路��追踪时视角晃动的问题**
...
* 修复了角色在自动秘境结束战斗时，若朝向正���方则无法自动转向古树的问题。 #608
...
```
## 新功能
**���增了自动烹饪的功能，在实时任务中开启（不用的时候请关闭，比较消耗性能）** #266
