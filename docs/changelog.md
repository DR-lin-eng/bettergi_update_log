...
## 其他
- 优化���动剧情-关闭弹窗-小道具的检测逻辑 (#2427) @1004452714
...
* 修改了路���追踪中战斗结束的判定点 @Scarlet1ssimo
...
* 联机情��下识别角色队伍时，修复错误识别房主的问题（会导致队伍识别出错） #777
