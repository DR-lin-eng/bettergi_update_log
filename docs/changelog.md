...
### 独立任务
- 修复自动地脉花追踪按钮���别与奖励页树脂点击异常 (#2971) @ddaodan
...
- 地��追踪添加不切换队伍配置，在自动地脉花功能上使用 #2955 @ddaodan
```
...
## 地图追踪
- 优化换队拾取，仅在配置了万��队伍时才执行换队操作 (#2748) @this-Fish
...
- **新增独立任务自动使用兑换码，自动识别剪切板中��兑换码** (#1895)
...
## 其他优化
- 优化抽屉关闭后重新开启的体验
- 一条龙��面添加自动秘境树脂选择弹窗 #1767 @kaedelcb
