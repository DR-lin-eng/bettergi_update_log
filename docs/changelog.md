...
- 新增遮罩样式自定义并支持分辨率与 DPI 自适应，可分别调整日���和指标栏缩放 (#3184 #3352) @ddaodan @kaedelcb
...
### 其他
- 完善首领讨伐的一��龙配置与战斗超时设置，并修复特殊地图体力识别、树脂弹窗和路线等待 (#3265 #3309 #3343 #3387) @1004452714 @Kirito520Asuna
...
- 新增 WinUI 风格导航选中动��并重写 Markdown 渲染组件 (#3369)
```
...
- 修复自���幽境危战切换队伍时可能误选首领的问题 (#3206) @bling-yshs
...
## 调度器与自动战斗
- 新增一条龙配置的重命���与删除 (#2658) @1004452714
...
- **自动��情-增加对“小道具”及“角色”弹窗的识别与关闭** (#2308)  @1004452714
- 修复键鼠文件夹不存在的问题 #2316
...
- 适配地图传送界面新出现“游逸旅闻：[地区名]”文字，对原有文字识别点击造成干扰的情��� @FishmanTheMurloc
...
- 修复打开活动一览操作可能提前的问题
- 修��幽境危战活动不在首位无法正常传送的问题 #2059 #2060
...
- 修复万叶长E拾取判���的CD计算错误 (#1958) @kaedelcb
...
- 修复迷烟主成员非飞行状态下四叶印识别��败的Bug，模板匹配的置信度修改为数组 @Limint
...
- 优化自动重新登录针对B服的登录框的操���，支持5.8版本的新登录框 @zaodonganqi
