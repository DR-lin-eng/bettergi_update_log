...
- 脚本读取图���时支持调整到指定尺寸 (#2446) @breadgrocery
...
- 降低飞行检测时间，自由落体��进入飞行再下落攻击 (#1837) @MisakaAldrich
...
* 软件自带默认黑名单与用户配置黑名单拆分，不会再出现��户配置的黑名单被覆盖的情况了
* 配置黑白名单可实时生效
* 修复自动拾取展示文本可能缺失标点的问题
