...
- 地图遮罩实时任务内匹配操作异步化，不再阻塞自动拾取���其他触发器
- 修复UI线程死锁的问题
...
- 使用 SetWinEventHook 优化日志遮罩针对原神窗口的跟���延迟 #2540
- 更多自动拾取黑名单
...
## 地图追踪
- 地图追踪异常��理支持自动关闭书页 (#2418) @JamisHoo
...
- 修复自动秘境选择火本（无妄引咎密宫）后，无法正��进入秘境的问题 #1345
