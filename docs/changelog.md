...
- 回滚“文本识别模糊匹配”���关改动，解决自动拾取卡的问题 (#2799) 
...
- 增加对话区判定次数 #2936 
- 优化TpTask惯性导��（误识别），处理初始未识别 (#2920) @physligl
- 切换角色问题测试用代码 
- 一条龙结束后关闭开书 #2686 
- 最后匹配自定义游戏进程名 #2909 
...
```
**这次更新新增了新版本的���装程序与自动更新程序（自动更新程序下版本才会有用）。**
...
* 修复tp时候，屏蔽左上角区域位置不正��的问题（屏蔽了但没完全屏蔽）
* 新增在路径追踪期间使用小道具的功能
