...
- 新增基于怪物死亡经验判断是���执行战后拾取 (#3051) @kaedelcb
...
- 修���地图追踪触发自动剧情异常处理有时无法完成对话的问题 (#2684) @Anyrainel
...
## 自动秘境/幽境/战斗
- 战斗策略中，上一个命令和当前命令不是同���个角色时，直接切换角色 #2411
...
- 修���领取尘歌壶奖励相关问题 (#2437) @breadgrocery
...
- **优化自动拾取对聚所的判断**
- **自动拾取添加模糊匹配的名单**
- 自动圣遗物转化功能可识��并标记未激活副词条 (#2258) @bhbghghbgb
...
- **自动幽境危战适配5.8，并加入一条龙中（注意当前无需在���启钥匙后的界面上启动本功能！）**
