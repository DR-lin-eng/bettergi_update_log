...
- **修复自动秘境使用指定树脂数量超出实际树脂��量时，不会自动退出秘境的问题**
- 修复重复退出秘境的问题
...
- 圣遗物分解套装筛��的改进和JS引擎的约束 (#2319) @FishmanTheMurloc
...
- **自动幽境危战适配5.8，并加入一���龙中（注意当前无需在开启钥匙后的界面上启动本功能！）**
