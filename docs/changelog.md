...
- 为快���尘歌壶任务增加离开功能，支持进出双向操作 (#2822) @this-Fish
- 支持任意游戏文件名的启动 (#2819)
...
- 修复 OCR RunMulti 中 Mat 所有权语义不明���导致的潜在 Dispose 问题 (#2730) @Ayu0K
...
## 其他
- 本地仓库使用全新版本
- 优化渊下宫文字的识别，修复文本识别���换功能的问题 @JamisHoo
- 优化对进入主界面的判断
- 优化快速购买时候，对洞天的识别率
...
- 修复钓鱼���候报错 File doesn't exist 的问题
- 更新窗口的UI变化
```
...
- 提��SetTimeTask的稳定性 (#2161) @JamisHoo
...
* 自动战斗后、传送���都会释放所有按键，尝试解决TP神像后持续往前走的问题
* 修复火元素采集不生效的问题
* 优化自动传送的稳定性 @physligl
...
* 调度器添加地图路径追踪任务时候的ui优化，默认不展开，且添加筛选���能
