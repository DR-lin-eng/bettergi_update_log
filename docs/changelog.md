...
- ��配 6.0 菈乌玛退队后队伍UI不会还原，但是跨地图传送后UI还原 的场景
...
由 @HZYgrandma 贡献，由于使用的是和自动晶蝶一样的自���传送+键鼠录制的方式，长距离可能无法精准到达点位。且由于键鼠录制不够稳定，出现无法正确拾取狗粮的情况属于正常情况。后续可能会通过地图追踪功能重写。
...
- 键鼠脚本的录制与回放从相对时间修改为绝对时间，大幅提高精��，减少卡顿，**但是不兼容 0.33 版本前的键鼠脚本** @lwh9346 
...
新增自动完成活动音游的独立任务，支持16:9的游戏大小，支持2倍速。**下落模��必须选择“垂落模式”**。建议配合快捷键使用。
