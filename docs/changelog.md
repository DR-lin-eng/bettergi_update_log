...
> [!IMPORTANT]
> **非常感谢 @Limint 贡献的新的相��视角识别算法，解决了路径追踪时视角晃动的问题**
...
* 一键进出尘歌壶，增加对多人联机下��入尘歌壶的支持 @FannieMC
...
* 角色识别模型加入`仆人`的识��（用于一键宏、自动战斗/秘境功能中的队伍识别）
