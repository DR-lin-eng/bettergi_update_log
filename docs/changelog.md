...
- 使用 SetWinEventHook 优化���志遮罩针对原神窗口的跟随延迟 #2540
- 更多自动拾取黑名单
...
## 其他
- 优化自动拾取的预处理环节，优化最终文字展现，使自动��取OCR识别更加稳定
- **自动拾取排除聚所**
- 自动秘境浓缩树脂识别优化
- 自动音乐专辑任务异常详情日志打印
...
## 独立任务
* 重构底层调度逻辑，使其方法能够对外调用
* **<kbd>F11</kbd> 关闭截图器的时候也会同���关闭所有独立任务** #388  #660
