...
- 回滚“文本识别模糊匹配”相���改动，解决自动拾取卡的问题 (#2799) 
...
- 修复ItemsSource=' 1234' 导致XAML设计���报错的问题 #2039
...
- 降低飞行检测时间，自由落��后进入飞行再下落攻击 (#1837) @MisakaAldrich
...
* 软件自带默认黑名单与用户配置黑名单拆分，不会再出��用户配置的黑名单被覆盖的情况了
* 配置黑白名单可实时生效
* 修复自动拾取展示文本可能缺失标点的问题
...
🌩️ [Github 下载太慢？ 点我��问更多更新渠道](https://bettergi.com/download.html)
```
...
* 将路径追踪相关的日志改为debug���别 (#1645) (#1684) @Patrick-Ze
