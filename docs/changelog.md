...
* 联机情况下识别角色队伍��，修复错误识别房主的问题（会导致队伍识别出错） #777
...
* 修复伐木上限配置无法突破2000的问题（荒��一斗被动可以突破这个值）。 #606
...
## 其他优化
* **修复非16:9屏幕在 0.29 版本新出现的问题：无法正常使用���分功能、遮罩识别框位置不正确**
...
为了实现 #95 做了底层重构，主要是为了在原来的基础上更好的支持高于1080P的分辨率，比如2k、4k。提���其处理性能。
...
> * 邀约分支修复了 **珐露珊、五郎、凝光、重云、鹿野院平藏** 分支不正确的问题，需要���动覆盖配置文件起效
