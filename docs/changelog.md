...
**添加了脚本��库，在线版 [https://bgi.sh/](https://bgi.sh/) （感谢 @DR-lin-eng 友情提供的域名），BetterGI本地也内嵌了相同的网页。**
