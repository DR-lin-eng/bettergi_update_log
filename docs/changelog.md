...
## 自动秘境
- 一条龙未选择要刷的秘境时，直接提示
- 修复4K分辨率下秘���无法自动点击掉地脉异常的提示内容的问题 #460
...
* 队伍识别失败时，沿用上一次识别成功的队伍。（算是解决了切换��色 1s CD 的时候，由于头像虚化导致队伍无法识别的问题）
* 配置修改后立即生效
...
## 自动剧情
- 添加OCR支持，当然消耗的性能也更多了 #149，可在 `User\AutoSkip` 下的配置文件中配�� “默认暂停”、“直接暂停”、“优先选择” 的选项文字。后续会添加配置 UI 。 #186
- 自动剧情可以默认选择第一个选项了
