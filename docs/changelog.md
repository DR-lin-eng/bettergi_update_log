...
- 脚本读取图片���支持调整到指定尺寸 (#2446) @breadgrocery
...
## 其他优化
- 优化��版本更新日志窗口的背景显示(未完全解决) (#1413) @richex-cn
...
## 自动秘境
- 一条龙未选择要刷的秘境时，直接提示
- 修复4K分辨率下秘境无法��动点击掉地脉异常的提示内容的问题 #460
...
- 修复自动拾取按���档指引改键无效 @Takaranoao #1262
