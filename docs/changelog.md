...
> 最后更新: 2026/8/26 16:46:15
> 数据来源: [GitHub Releases](https://github.com/babalae/better-genshin-impact/releases)

## 0.64 原神 7.0 适配

**版本:** `0.64.0`
**发布时间:** 2026/8/23 16:25:33
**GitHub页面:** [查看详情](https://github.com/babalae/better-genshin-impact/releases/tag/0.64.0)

### 更新内容

```
本次适配原神7.0至冬内容，新��自动演奏和自动拾取白名单，优化地图传送稳定性。
...
- 优化奖励页就绪检测与数量��别，减少奖励汇总遗漏 (#3476 #3494) @1004452714
...
- 获取剪贴板兑换码时忽略 URL，避免把链接���容误识别为兑换码 (#3470) @girl-dream
...
**版本:** `0.63.0`
**发布时间:** 2026/8/6 23:44:15
**GitHub页面:** [查看详情](https://github.com/babalae/better-genshin-impact/releases/tag/0.63.0)
...
- 扩展视觉脚本 API，新增 `BvFlow` ��式流程、模板匹配得分 (#3340 #3389) @1004452714 
...
- 统一页面排版、边距和滚��交互，并修复主导航容器显示细节 (#3303) @Arkadegong
...
**版本:** `0.62.0`
**发布时间:** 2026/7/5 10:40:50
**GitHub页面:** [查看详情](https://github.com/babalae/better-genshin-impact/releases/tag/0.62.0)
...
- 自动秘境和自动首领讨伐���增奖励名称与数量识别、跨轮汇总及 JS 返回结果支持 (#3208) @1004452714
...
**版本:** `0.61.2`
**发布时间:** 2026/6/1 21:59:51
**GitHub页面:** [查看详情](https://github.com/babalae/better-genshin-impact/releases/tag/0.61.2)
...
**版本:** `0.61.0`
**发布时间:** 2026/5/24 22:19:34
**GitHub页面:** [查看详情](https://github.com/babalae/better-genshin-impact/releases/tag/0.61.0)
...
- 重构万叶战后长 E 拾取逻辑，增强防卡��保护 (#3101 #3108) @火山
...
- 任务启动阶���可通过快捷键终止，强制关闭游戏时启动按钮可复位 (#3036) @zhousenyu
...
- 自动地脉花优化挪德卡莱 3「月矩力试验设��局」路径 (#2991) @ddaodan
- 优化新版自动秘境奖励通知时机
...
- 为快速尘歌壶任务增加离开功能，支持进���双向操作 (#2822) @this-Fish
- 支持任意游戏文件名的启动 (#2819)
...
- **修复自动秘境使用指定树脂数量超出实际树脂数量时，不会���动退出秘境的问题**
- 修复重复退出秘境的问题
...
- 圣遗物分解套装筛选的改进和JS��擎的约束 (#2319) @FishmanTheMurloc
...
- 添加火元素采集选项到条件定义 #2159
- 优化 地图追��任务添加窗口 性能，修复了索引时文件树复选框不被记忆的BUG (#2157) @Datouyu666
...
- 修复自定义的交互按键未对自动秘境生效���问题 (#2035) @Patrick-Ze
- 地图追踪中新增使用小道具的action
...
- 调度器添加地图追踪文件���自动聚焦搜索框 (#1916) @Arkadegong
...
- 修复地图追踪配置中获取材料名称的��题 (#1919) @kaedelcb
- 地图追踪版本要求修改为强制
- 优化地图追踪的距离过远判断
...
🌩️ [Github 下载太慢？ 点我访问更多更新��道](https://bettergi.com/download.html)
...
## 一条龙
* 自动秘境：添加周日材料本三种奖��选择、优化进入秘境横幅点击 @kaedelcb
...
## 自动拾取
- **拾取列表已满时候，滑动���轮（注意这个变更会会导致拾取变成从下往上拾取，对于尘歌壶收菜有一定影响）**
...
- 打开地图时判断是否存在探索奖励，并自动领取（需要在��置中打开） @mfkvfhpdx 
...
* 添加可以��照正则分解五星圣遗物的 (#1383) @FishmanTheMurloc
* JS 脚本新增文件写入、输入文字的能力
...
```
> [!CAUTION]
> 由于本次更新修改了底层截图器与任务调度，这并不是��个稳定的版本，请谨慎选择更新！
