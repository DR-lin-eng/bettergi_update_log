...
* 自动战斗后、传送前都���释放所有按键，尝试解决TP神像后持续往前走的问题
* 修复火元素采集不生效的问题
* 优化自动传送的稳定性 @physligl
...
> [!IMPORTANT]
> **地图追踪功能**：自动传送到最近的锚点，然后根据小地图开始寻路。系统会根据任务文件的��径点和目标点进行导航。
...
```
此版本新增了一些实验中功能，这些功能后续可能会进行大规模��动。
