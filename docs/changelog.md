...
- 修复七圣召唤月之��伊涅芙会导致手牌不可调和的死循环 (#2848) @Guest-Liang
...
## 其他
- **同时启动原神的功能，添加使用CMD启动游戏的入口，如��你出现“检测到非法工具，请重启机器”的提示，可以尝试此功能**
...
- **自动幽境危战适配5.8，并加入��条龙中（注意当前无需在开启钥匙后的界面上启动本功能！）**
