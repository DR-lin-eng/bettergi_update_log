...
- 退回到主界面函数支持识别更多场景
- 暴露设置时间方法（跳��动画实测未生效） (#2426) @zaodonganqi
...
- 修复 AutoDomainParam ��型定义 @breadgrocery
...
- 优化地图切��区域时的文本检测区域 (#2275) @ShadowLemoon
