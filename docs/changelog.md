...
**新增自动演奏，支持多种曲谱格式、筛选播放与自���切换乐器 (#3419)**
...
- JS 获取小地图位置坐标新��� matchingMethod 参数
...
- 地图追踪增加读取目录下的内容��方法 (#2875) @1004452714
...
- 挪德卡莱中心点更新（修复不会自动选择挪德卡莱的���题）/联机时不执行自动派遣 (#2323) @kaedelcb
