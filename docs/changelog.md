...
- 识别选��队伍后队伍切换成功的场景，减少因为切换时间过长而引发的队伍切换失败的问题 #1457
...
```
> [!CAUTION]
> 由于本次更新修改了底层截图器与任务调度，这并不是一个稳��的版本，请谨慎选择更新！
...
* 修复自定义拾取按键不生���的问题 #1262 @Takaranoao
