...
- 取消兑换码使用后不再弹���此剪切板内容的兑换码，新增兑换码剪切板监听的开关配置
...
- 修复并发调用小地图识别时��别错误的Bug，修改并增加暴露给JS的小地图识别函数 (#1911) @Limint
...
```
* 依��库OpenCvSharp4、PaddleOCR版本更新 @Takaranoao
