...
## 改动
* 修复非 1080P ���口下（2K、4K等），自动秘境无法正常使用树脂的问题
...
* 优化BitBlt截图逻辑，增加失败重���机制以提高截图成功率 (#1407) @Takaranoao
...
```
> [!CAUTION]
> 由于本次更新修改了底层截图器与任务调度，这并不是一个稳定的版本，请谨慎选择���新！
