...
- 添加火元素采集选项到条件定义 #2159
- 优��� 地图追踪任务添加窗口 性能，修复了索引时文件树复选框不被记忆的BUG (#2157) @Datouyu666
...
- 增加对WaypointForTrack的DisablePickupAround属性支持，可以关闭挖矿��作的周围拾取 @Takaranoao #1322
