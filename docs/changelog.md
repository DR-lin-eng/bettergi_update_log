...
## 其他
- **修复JSON序列化问题，本质原因是OCR模块指针指���的内存出现错误，感谢群友 焦糖玛奇朵
 提供环境协助定位！**。
...
* 截图器优化。 #1480 #1573 @shatyuka 
    ...
    * WGC 优化窗口大小检测优化
    * “选择捕获窗口”优化，置顶原神等
* 使用 Image<Rgb24>替换 Bitmap，减少 YOLO 推理时图像格��转换带来的损失 #1563 @shatyuka
...
- 修复高DPI��TP地图往复移动的问题 (#1469) @shatyuka
...
* win10不再展示毛玻璃主题切换按钮
* 完成秘境后释放所有按键 #1073
* 修复 `bettergi://start/` 不生效的问题（胡桃工具��联动启动失效问题）
...
## 一条龙
* 把领取历练点任务改放在了领��奖励模块（在切换好感队之后） #955
* 修复枫丹台成台成女角色容易跑过头的问题
