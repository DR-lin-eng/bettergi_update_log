...
- 回滚“文本识别模糊匹配”相关改动，解决自动��取卡的问题 (#2799) 
...
- 修复模��黑名单读取错误的文件路径 (#2635) @yanmofeixi
- 一条龙冒险家协会添加挪德卡莱
...
- 配置弹窗UI优化，更新截取物品图标导航��址 (#2499) @zaodonganqi
...
- 支持自定义脚本仓库地址 @ddaodan
- 支持在脚本中进行 HTTP 请求，并��现 URL 级别细粒度控制和 UI 提示  (#2331)
...
- 检测战斗结束增加旋转��找敌人实验性功能 (#1960) @kaedelcb
...
* 软件自带默认黑名单与用户配置黑名单拆分，不会再出现用户配置的黑名单被覆盖的情���了
* 配置黑白名单可实时生效
* 修复自动拾取展示文本可能缺失标点的问题
...
## 其他优化
- 优化新版本更新日志窗口的背景���示(未完全解决) (#1413) @richex-cn
...
## 自动秘境
- 一条龙未选择要刷的秘境时，直接提示
- 修复4K分辨率下秘境无法自动点击掉地脉异常的提示���容的问题 #460
