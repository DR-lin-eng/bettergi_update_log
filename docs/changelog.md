...
- **修复自动秘境使用指定树脂数量超出实际树脂数量时，不��自动退出秘境的问题**
- 修复重复退出秘境的问题
...
## OCR 相关
- **OCR模型更新�� PaddleOcrV5** (#1966) @Takaranoao
- 强制OCR使用CPU的功能默认关闭
...
- 调度器配置中增加执行成功任务跳过执行配�� (#1893) @mfkvfhpdx
...
* 自动战斗后、��送前都会释放所有按键，尝试解决TP神像后持续往前走的问题
* 修复火元素采集不生效的问题
* 优化自动传送的稳定性 @physligl
