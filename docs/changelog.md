...
- 优化地图追踪过程中各种���断的处理 (#2425) @JamisHoo
...
- 删除这两个选项：是否就近七天神像���复血量、传送到七天神像之后是否需要移动后回血
...
- **地图特征使用��进制文件存储，减小文件体积，大幅提升特征数据加载速度** @shatyuka
...
- 自动剧情关闭弹出页前判断是否是��地图的弹出页面，以防误识别 #1466
...
**添加了脚本仓库，在线版 [https://bgi.sh/](https://bgi.sh/) （感谢 @DR-lin-eng 友情提供的域名），BetterGI本地也内嵌了��同的网页。**
