...
- 修复���发调用小地图识别时识别错误的Bug，修改并增加暴露给JS的小地图识别函数 (#1911) @Limint
...
* 在未识别到配队选择页面时重试
* 新增命��行： `.\BetterGI.exe startOneDragon`，支持在软件启动后直接启动一条龙 #998
...
> [!IMPORTANT]
> **非常感谢 @Limint 贡献的��的相机视角识别算法，解决了路径追踪时视角晃动的问题**
