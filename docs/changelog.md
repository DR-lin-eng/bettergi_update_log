...
- **自动剧情-增加对“小道具”及“角色”弹窗的识别与���闭** (#2308)  @1004452714
- 修复键鼠文件夹不存在的问题 #2316
...
- 修复创建配置��添加js脚本后，首次编辑js脚本自定义配置时，组件无法正确绑定到setting.json中的默认值 (#1449) @breadgrocery
- 调用切换队伍方法后，清除队伍缓存
...
- **新增支持独立地图层岩���渊、渊下宫，录制编辑器和追踪地图查看同步支持**
