...
- ���化自动剧情-可提交物品的识别方法 (#2477) @1004452714
...
- 切换队伍适配新版本最大队伍数由15增加到20，并新增最��一个非空队伍判断 @FishmanTheMurloc
...
- 新增自动使用���物的Task供JS脚本调用 @FishmanTheMurloc
...
## 其他优化
* 修复保存键鼠脚本时丢失最后一个MacroEvent的���题 @Ayu0K #1178
...
* win10不再展示毛玻璃主题切换按钮
* 完成秘境后释放所有按键 #1073
* 修复 `bettergi://start/` 不生效的问题（胡桃工具箱联���启动失效问题）
...
- 修复更新提示弹窗位��未适配高分屏DPI缩放 #446 @emako 
...
Paddle 文字识别暂时不能切换（测���切换后效果非常差）。图像推理相关的速度有大幅提升。
