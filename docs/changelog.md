...
- **地图特征使用二进制文件存储，减小文件��积，大幅提升特征数据加载速度** @shatyuka
...
- 自动剧情关闭弹出页前判断是否是大地图的弹出页面，以防误��别 #1466
...
```
* 修复手���设置cd不生效和快速跳过战斗时有时会导致刷屏的问题(#1410) @Takaranoao
