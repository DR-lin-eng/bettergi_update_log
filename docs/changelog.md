...
- 适配月绽放角色（菈乌玛）入队后，角色无法正常切换的问题。（右侧队伍下方出现草露进度条，会让整个队伍UI上移，后续换队后UI依��保持原样）
...
- 地图追踪版本要求修改为强制
- 优化地图追踪的距离过远判断
- 修复地图追踪中角色公转的场景，���续角度一直未在5度内时，直接强制等到转向到目标位置 #1644
...
* 一键进出尘歌壶，增加对多人联机下进入尘歌��的支持 @FannieMC
...
**自动调查离传送点较近的狗粮。请使用琳妮特前台，双风共鸣。并保证��有传送点都已经激活！**
