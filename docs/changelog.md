...
- 优化每日委��领奖，使用点击屏幕替代按ESC (#2761) @zaodonganqi
...
- 修复高缩放下日志���窗口消失 (#2585) @ShadowLemoon
...
- 优��地图追踪过程中各种打断的处理 (#2425) @JamisHoo
...
- 调整浓缩树脂识别范围，解决V4模型无法准确识别��缩树脂个数的问题 #2185
...
## 其他
- 修复 OpenVINO ��存配置与描述冲突（注：当前正式版 OpenVINO 不能启用） @Luckylhz
...
- 飞书通知时带有图片(需要配置app,并且在飞书���台增加上传图片权限) @niuhuan
