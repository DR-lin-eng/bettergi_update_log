...
* 一键进出尘歌壶，增加对多���联机下进入尘歌壶的支持 @FannieMC
...
## 独立任务
* 重构底层调度逻辑，使其方法能够对外调用
* **<kbd>F11</kbd> ��闭截图器的时候也会同时关闭所有独立任务** #388  #660
