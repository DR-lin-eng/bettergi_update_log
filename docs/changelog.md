...
- 修复角色索引识别偏差导致��切换问题 (#3035) @JerryChen97
...
- 原神 HDR 自动关闭功能
- 一条龙任��新增"关闭软件"完成动作 (#3115) @lingse4
...
* 优化一条龙领取奖励时，橙色选项的识别率
* 修改所有自动战斗的键鼠模拟方式，尝试修��自动战斗原地不动的问题
* 部分UI改造，部分文案修正
```
...
* 感谢 @xyToki 提供的自动更新程序与服���，项目 [kachina-installer](https://github.com/YuehaiTeam/kachina-installer) ！
* 感谢 @Womsxd 提供的额外流量节点！
