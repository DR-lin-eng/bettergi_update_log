...
- 调度器配置中增加执行成功任���跳过执行配置 (#1893) @mfkvfhpdx
...
![image](https://github.com/user-attachments/assets/47b54ac1-b524-4f62-a7a0-8e2b83221cf0)
    ...
    * 解决方案：关掉后重试一次，手动运行BetterGl.update.exe（此时打开软件应该已经是最新版了）。如果还是不行，可以直��重新下载安装包安装。
