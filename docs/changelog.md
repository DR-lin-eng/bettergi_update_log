...
* 添加使用Starward记录游戏时间��功能 @kndxhz #1164
...
* 修复windows10 1909版本使用WGC会报��的问题 @masm611 #954
* 更多傻瓜化日志提示
...
## 独立任务
* 重构底层调度逻辑，使其方法能够对外调用
* **<kbd>F11</kbd> 关闭截图器的时候也会同时关闭所有��立任务** #388  #660
